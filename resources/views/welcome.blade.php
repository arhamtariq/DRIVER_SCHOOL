            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <a class="btn_1 d-none d-lg-block" href="#">Login</a>
                    </nav>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6">
                                    <div class="search_form_iner">
                                            ...
                                            <input type="text" name="address" id="post_codes" placeholder="Post Code" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Post Codes'" required="" class="single-input">
